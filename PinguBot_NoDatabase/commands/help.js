...
const {prefix, FooterText, FooterURL, BotImageURL, ThumbNail, BotOwnerName, BotOwnerImageURL} = require('../config.json');
	...
	execute(message, args) {
        ...
        switch(choice){
            ...
            case 'fun':
                ...
                .addField('Say', `Makes Pingu Bot say something on your behalf. \nUsage: ${prefix}say`, false)
            ...
            default:
                ...
                .setURL('https://discord.js.org/')
                .setAuthor(BotOwnerName, BotOwnerImageURL, 'https://discord.js.org')
